...
export default buildConfig({
  ...
  sharp,
  // Allowlist de orígenes para CORS + CSRF de las cookies de sesión del admin.
  // Se construye desde las env vars de URL pública; si ninguna está seteada
  // (p.ej. en algunos entornos de dev) se cae al comportamiento permisivo.
  // IMPORTANTE: en producción PAYLOAD_PUBLIC_SERVER_URL debe ser exactamente
  // el dominio desde el que se sirve /admin, o el login fallaría por CSRF.
  ...(() => {
    const origins = [
