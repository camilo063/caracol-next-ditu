...
export interface HomeContactModalProps {
  ...
  /** Elemento decorativo que flota en la esquina superior derecha del modal (ej: PatoDitu). */
  topRightDecoration?: React.ReactNode;
  /** "ditu" aplica paleta morada/verde del ecosistema Ditu. */
  tone?: "ditu";
}
  ...
  return (
    <AnimatePresence>
      {open ? (
        ...
        >
          {topRightDecoration && (
            <div className="pointer-events-none absolute -top-[48px] right-0">
              {topRightDecoration}
            </div>
          )}
          <div
          ...
          >
            ...
            <button
              ...
              onClick={onClose}
              aria-label="Cerrar"
              className={`absolute top-2 right-2 flex h-[28px] w-[28px] cursor-pointer items-center justify-center rounded-full transition-all duration-200 hover:scale-110 ${isDitu ? "hover:bg-[#561BDB]/10" : "hover:bg-[#015BC4]/8"}`}
            >
              <svg
                width="18"
                height="18"
              ...
              >
                <path
                  ...
                  stroke={isDitu ? "#561BDB" : BLUE_MEDIUM}
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  ...
                  <div className="flex w-full items-center gap-[8px]">
                    ...
                    {isDitu ? (
                      <a
                        ...
                        className="group relative inline-flex flex-1 items-center justify-center overflow-hidden rounded-[4px] px-[16px] py-[4px] text-[12px] font-bold whitespace-nowrap text-white active:scale-[0.97]"
                        style={{ minHeight: "32px", lineHeight: "16px" }}
                      >
                        <span
                          aria-hidden="true"
                          className="absolute inset-0 bg-[linear-gradient(90deg,#8232F0_0%,#561BDB_100%)] transition-opacity duration-300 group-hover:opacity-0"
                        />
                        <span
                          aria-hidden="true"
                          className="absolute inset-0 bg-[linear-gradient(90deg,#561BDB_0%,#8232F0_100%)] opacity-0 transition-opacity duration-300 group-hover:opacity-100"
                        />
                        <span className="relative">Correo</span>
                      </a>
                    ) : (
                      <a
                        href={`mailto:${rep.email}`}
                    ...
                    {isDitu ? (
                      <a
                        ...
                        className="group relative inline-flex flex-1 items-center justify-center gap-[6px] overflow-hidden rounded-[4px] px-[16px] py-[4px] text-[12px] font-bold whitespace-nowrap text-white active:scale-[0.97]"
                        style={{ minHeight: "32px", lineHeight: "16px" }}
                      >
                        <span
                          aria-hidden="true"
                          className="absolute inset-0 bg-[linear-gradient(90deg,#31E675_0%,#13BA51_100%)] transition-opacity duration-300 group-hover:opacity-0"
                        />
                        <span
                          aria-hidden="true"
                          className="absolute inset-0 bg-[linear-gradient(90deg,#13BA51_0%,#31E675_100%)] opacity-0 transition-opacity duration-300 group-hover:opacity-100"
                        />
